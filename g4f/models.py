...
class Model:
    ...
    class gpt_35_turbo:
        ...
        best_provider: Provider.Provider = random.choice([Provider.DeepAi, Provider.Easychat, Provider.Chatanywhere])

    class gpt_35_turbo_0613:
        name: str = 'gpt-3.5-turbo-0613'
        base_provider: str = 'openai'
        best_provider: Provider.Provider = random.choice([Provider.Easychat, Provider.Chatanywhere])
